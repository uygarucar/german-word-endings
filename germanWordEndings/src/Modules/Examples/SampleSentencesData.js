...
const SampleSentenceEnglish = {
    'accusative': {
        'masculine': {
            ...
            'without': {//no adj.
                'no': <Text>"I've seen man"</Text>, // No article
    ...
    'dative': {
        'masculine': {
            ...
            'without': {
                'no': <Text>I've helped to man</Text>,
        ...
        'feminine': {
            ...
            'without': {
                'no': <Text>I've helped to woman</Text>,
        ...
        'neutral': {
            ...
            'without': {
                'no': <Text>I've helped to child</Text>,
    ...
    'nominative': {
        'masculine': {
            ...
            'without': {
                'no': <Text> Man was looking for you</Text>,
        ...
        'feminine': {
            ...
            'without': {
                'no': <Text>Woman was looking for you</Text>,
        ...
        'neutral': {
            ...
            'without': {
                'no': <Text>Child was looking for you</Text>,
    ...
    'genitive': {
        'masculine': {
            ...
            'without': {
                'no': <Text>Money of man is missing</Text>,
        ...
        'feminine': {
            ...
            'without': {
                'no': <Text>Money of woman is missing</Text>,
        ...
        'neutral': {
            ...
            'without': {
                'no': <Text>Money of child is missing</Text>,
